...
function correctedData = SplineCorrection(timeSeriesData, acquisitionFrequency, motionThreshold, K)

    if isempty(K)
        K = round(2.5 * acquisitionFrequency);
    end
    correctedData = MotionCorrectionMARA(timeSeriesData, acquisitionFrequency, motionThreshold, K);
